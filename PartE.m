...
% Initialize Figures
figure('Name','1D Electron Simulation with Scattering','NumberTitle','off');
...
% Simulation Loop with Animation and Scattering
for n = 2:num_steps
    % Check for scattering
    if rand() < scatter_prob
        v(n-1) = 0;  % Scattered, set previous velocity to 0
    end
